...
## 0 speed upgrades
execute as @a if score @s energy matches 1.. if score @s is_sprinting matches 1.. if score @s run_speed_upgrade matches 0 run effect give @s minecraft:speed 1 0 true
## 1 speed upgrade
execute as @a if score @s energy matches 1.. if score @s is_sprinting matches 1.. if score @s run_speed_upgrade matches 1 run effect give @s minecraft:speed 1 1 true
## 2 speed upgrades
execute as @a if score @s energy matches 1.. if score @s is_sprinting matches 1.. if score @s run_speed_upgrade matches 2.. run effect give @s minecraft:speed 1 2 true
# Restore energy
